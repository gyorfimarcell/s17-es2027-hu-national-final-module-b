...
Please see the [assets/c1/index.js](assets/c1/index.js) file.
...
Please see the [assets/c2/index.js](assets/c2/index.js) file.
...
Please see the [assets/c3/index.js](assets/c3/index.js) file.

## Assessment

Evaluation will consider correctness, robustness, and code quality. Solutions will be tested in modern browsers (Chrome is used for feature testing such as Picture-in-Picture). C-task scripts (`/c1`, `/c2`, `/c3`) may be executed locally with Node.js for correctness verification.

Automated and manual checks may include:

- Functionality and correctness of the implementations
- Responsive behaviour and layout across breakpoints
- Export behaviour for downloadable assets (e.g., `drawing.png`)
- Use of required technologies (HTML/CSS for A tasks; JavaScript where specified)
